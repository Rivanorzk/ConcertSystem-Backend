    ...
    export const createOrder = async (userId, body) => {
        ...
        try {
            ...
            if (body.voucher_code) {
                ...
                if (totalTicket < voucher.minimum_quantity) {
                    throw new AppError(
                        `Minimal pembelian ${voucher.minimum_quantity} tiket`,
                        400
                    );
                }
                ...
                if (voucher.discount_type === "percentage") {
                    ...
                    if (
                        ...
                        discountAmount = Number(voucher.maximum_discount);
                    }
                ...
                // Jangan sampai diskon melebihi total harga, supaya tidak
                // melanggar CHECK constraint (discount_amount <= total_price
                // dan final_price = total_price - discount_amount).
